...
namespace FoodTracker.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20210519042713_AddApplicationUserIdToUserProfile")]
    partial class AddApplicationUserIdToUserProfile
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodTracker.Domain.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("FoodTracker.Domain.Entities.ProductReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("FoodTracker.Domain.Entities.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("FoodTracker.Domain.Entities.UserProfile", b =>
                {
                    ...
                    b.Property<DateTime>("NotificationsLastSeen")
                        .HasColumnType("timestamp without time zone");
            ...
            modelBuilder.Entity("FoodTracker.Domain.Entities.DiaryEntry", b =>
                {
                    ...
                    b.HasOne("FoodTracker.Domain.Entities.ProductVersion", "ProductVersion")
                        .WithMany()
                        .HasForeignKey("ProductVersionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FoodTracker.Domain.Entities.ProductServing", "Serving")
                        .WithMany()
            ...
            modelBuilder.Entity("FoodTracker.Domain.Entities.Review", b =>
                {
                    b.HasOne("FoodTracker.Domain.Entities.UserProfile", "Client")
                        .WithMany()
            ...
            modelBuilder.Entity("FoodTracker.Infrastructure.Identity.ApplicationUser", b =>
                {
                    b.HasOne("FoodTracker.Domain.Entities.UserProfile", "UserProfile")
                        .WithOne()
                        .HasForeignKey("FoodTracker.Infrastructure.Identity.ApplicationUser", "UserProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
